...
public class ServiceHandler extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
				...
				sci = (StringCompareImpl)Naming.lookup("rmi://"+remoteHost+"1099/StringCompareImpl"); 
		...
		if (taskNumber == null){
			...
			jobNumber++;
			Requester reqes = new Requester(algorithm,s,t,taskNumber);
			//adding it to queue
			inQueue.add(reqes);
		}else{
